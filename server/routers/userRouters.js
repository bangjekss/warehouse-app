...
const { registerValidator, decryptToken, changePasswordValidator, loginValidator } = require("../middlewares");
...
// router.patch("/change-password-with-email", decryptToken, changePasswordValidator, changePassword);
// router.patch("/change-password-without-email", changePasswordValidator, changePassword);
