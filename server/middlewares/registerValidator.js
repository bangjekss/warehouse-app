...
// 				if (!email.match(emailRegex)) return res.status(202).send({ status: "Success", message: "Unvalid email" });
...
// 					return res.status(202).send({ status: "Success", message: "Email already taken" });
